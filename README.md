  This README file is a tl;dr of the full paper, which can be read [here](https://noahtren.github.io/media/digit_noah_trenaman.pdf). This file is more focused on the specific software used.
